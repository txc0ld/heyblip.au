        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-[var(--border-strong)] text-sm font-medium text-[var(--muted-strong)] hover:text-white hover:border-[var(--muted)] transition-all duration-200"
            >
