        ...
        >
          ...
          <div className="space-y-10 text-[var(--muted-strong)] text-[15px] leading-[1.8]">
            <div>
              ...
              <p>This Acceptable Use Policy outlines the expected behaviour of all Blip users. Blip is built to keep people safe and connected at events — we expect all users to use the platform responsibly.</p>
            </div>
